clear
%%
%--load player's data and All star team label for trainning and testing--%
load('AllstarTeamRandperm.mat');
load('AllstarTeamTest');
%%
%----------transfer the data into training part and tesing part----------%
train_label = cell2mat(M1(:,4));
train_label = (train_label - 0.5)*2;%transfer 0 label into -1
train_inst = cell2mat(M1(:,[9,(11:1:34)]));

test_label = cell2mat(allstarTest(:,4));
test_label = (test_label - 0.5)*2;%transfer 0 lalel into -1
test_inst = cell2mat(allstarTest(:,[9,(11:1:34)]));
%%
%------------normalize the data------------------------------------------%
...
switch kerType
    case 1
        save All_Star__Lin_test bestc Accuracy_raw Accuracy_pool Accuracy_largepool
    case 2
        save All_Star__Rbf_test bestc bestg Accuracy_raw Accuracy_pool Accuracy_largepool
end