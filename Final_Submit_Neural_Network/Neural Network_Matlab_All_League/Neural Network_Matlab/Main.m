% Final Project
% Neural Network main program for implement of predicting all league player.
...
load('X.mat');              % This is our traing set for 23 features data for all samples.
load('y.mat');              % This is our label for each sample. 
...
fprintf('\nPredicting all league player Accuracy: %f\n', rate * 100);
